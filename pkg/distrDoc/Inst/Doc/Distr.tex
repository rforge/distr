...
\end{Sinput}
\begin{Soutput}
 [1]  6.241509  4.255878 10.157096  6.552644 10.408005  9.139607  9.492226
 [8]  4.719508  9.590499 11.083819  7.460663  9.521220  3.986724 10.073012
[15]  6.074737  8.801221  8.959170  4.500947  6.326799 10.237874 11.903103
[22] 11.580105  6.946968  4.408885  9.964763  5.276061 15.118674 10.536000
[29]  4.825118 10.905699  8.768601  7.477989  3.450973 13.651364  5.504031
[36] 10.865972 10.360069  7.676843  9.748552  9.973526  7.946040  8.641474
[43]  9.838526  9.240986  9.799410  7.288146 10.473106  5.972859 13.561151
[50]  8.286181
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
 [1] -0.37071086  0.80980890  1.74966290 -0.02922246  2.24155515  2.59616560
 [7]  1.51202959 -0.71274533  0.51371994  1.03078964
\end{Soutput}
\end{Schunk}
%
...
\end{Sinput}
\begin{Soutput}
Kolmogorov distance of cdfs:	 2.028446e-07 
\end{Soutput}
\begin{Sinput}
> # 2.03e-07
> 
...
\end{Sinput}
\begin{Soutput}
6.552639e-05 with absolute error < 5.5e-06
\end{Soutput}
\begin{Sinput}
> ### meanwhile realized in package "distrEx" 
> ### as TotalVarDist(N1,N2)
...
\end{Sinput}
\begin{Soutput}
Kolmogorov distance of cdfs:	 6.538083e-05 
\end{Soutput}
\begin{Sinput}
> # ~5e-06
> 
...
\end{Sinput}
\begin{Soutput}
 [1]  0.2322964  0.6596313 -0.5000000  1.0000000  1.0000000  0.2558002
 [7]  0.4347652  0.9595039  0.2010964 -0.5000000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
 [1] -0.3951692  0.9185585  0.6478132  0.1829098  0.8735308  0.8754917
 [7]  0.3840936  0.4335924 -0.2598434  0.4525272
\end{Soutput}
\begin{Sinput}
> oldpar = par()
> par(mfrow = c(1,2))
...
Seed:  Kind: Mersenne-Twister
       ...
       first 6 numbers:  0188430748	 0971694936	-0330153779
                        -0302019877	 0200422946	-1503041535
number of runs: 1000
...
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mean.id: num  -0.2571 -0.1581 -0.0351 -0.0396 -0.1863 ...
 $ mean.re: num   0.1007  0.6255  0.2028 -0.0396  0.4015 ...
----------------------------------
An Evaluation Object
estimator: mestimator
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mstm.id: num  -0.2933 -0.0780 -0.0963 -0.0633 -0.2114 ...
 $ mstm.re: num  -0.1524  0.0622 -0.0255 -0.0633 -0.1276 ...
----------------------------------
An Evaluation Object
estimator: median
Result: 'data.frame':	1000 obs. of  2 variables:
 $ medn.id: num  -0.3372  0.0169 -0.1058  0.0671 -0.1607 ...
 $ medn.re: num  -0.2521  0.1521 -0.0627  0.0671 -0.1461 ...
name of Evaluation List: a list of "Evaluation" objects
name of Dataobject: object
name of Datafile: contsim_01
----------------------------------
...
Result:
    mean.id             mean.re         
 Min.   :-0.602897   Min.   :-1.951351  
 1st Qu.:-0.140631   1st Qu.:-0.314385  
 Median :-0.004469   Median :-0.004854  
 Mean   :-0.010057   Mean   : 0.004532  
 3rd Qu.: 0.115294   3rd Qu.: 0.335325  
 Max.   : 0.493840   Max.   : 1.904512  
----------------------------------
name of Evaluation: object
estimator: mestimator
Result:
    mstm.id            mstm.re         
 Min.   :-0.64719   Min.   :-0.653427  
 1st Qu.:-0.15283   1st Qu.:-0.160285  
 Median :-0.01076   Median :-0.005312  
 Mean   :-0.01220   Mean   :-0.011271  
 3rd Qu.: 0.13080   3rd Qu.: 0.148967  
 Max.   : 0.55204   Max.   : 0.552036  
----------------------------------
name of Evaluation: object
estimator: median
Result:
    medn.id             medn.re        
 Min.   :-0.797128   Min.   :-0.80534  
 1st Qu.:-0.171668   1st Qu.:-0.17828  
 Median :-0.008259   Median :-0.01176  
 Mean   :-0.015120   Mean   :-0.01360  
 3rd Qu.: 0.146195   3rd Qu.: 0.15249  
 Max.   : 0.672417   Max.   : 0.68941  
\end{Soutput}
\end{Schunk}
