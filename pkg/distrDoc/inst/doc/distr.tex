...
\end{Sinput}
\begin{Soutput}
 [1]  9.288694  4.576967  3.512912 15.216556 13.060574  9.437486  6.427431
 [8]  9.030969  8.214509  6.900995  8.048989 10.628034 12.379593  5.658345
[15]  8.145119 12.096213  8.459589 11.512774  9.157395  9.522572  3.984135
[22]  7.135684  6.663532  6.513837  7.303875  6.530920  8.945630 10.448619
[29] 10.664973  4.566546 10.021895 12.716965  7.278513  8.970221  8.709571
[36]  9.261344  5.839015  6.617721  2.756151  4.977021  8.579929  8.363237
[43]  8.517312 16.287078 11.633598 11.040527  8.371144  9.148037  8.968029
[50]  6.726433
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
 [1]  1.6693723 -1.2088743  1.4404844  0.5719124  0.3929034 -1.0871016
 [7] -0.7330518  2.4797310  2.7665075 -0.7798372
\end{Soutput}
\end{Schunk}
%
...
\end{Sinput}
\begin{Soutput}
Kolmogorov distance of cdfs:	 2.028322e-07 
\end{Soutput}
\begin{Sinput}
> # 2.03e-07
> 
...
\end{Sinput}
\begin{Soutput}
 [1]  0.3709034 -0.5000000  0.9245708 -0.4608269 -0.3728653 -0.5000000
 [7]  0.7466932  1.0000000  1.0000000  1.0000000
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
 [1]  0.02564801  0.64409948  0.05660709  0.36937539  0.86032468 -0.03851449
 [7]  0.13829957  0.25375476  0.80326993 -0.43652554
\end{Soutput}
\begin{Sinput}
> oldpar = par()
> par(mfrow = c(1,2))
...
Seed:  Kind: Mersenne-Twister
       ...
       first 6 numbers:  0167855728	 0243909791	-0110232968
                         0475867250	 1479810737	 0876248881
number of runs: 1000
...
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mean.id: num  -0.1518  0.0163  0.0052  0.0312  0.1304 ...
 $ mean.re: num  -0.0328  0.4330 -1.3011 -0.6845 -0.4123 ...
----------------------------------
An Evaluation Object
estimator: mestimator
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mstm.id: num  -0.0776  0.1115  0.0470  0.0452  0.1489 ...
 $ mstm.re: num   0.0128  0.1345  0.0457 -0.1728  0.1489 ...
----------------------------------
An Evaluation Object
estimator: median
Result: 'data.frame':	1000 obs. of  2 variables:
 $ medn.id: num   0.0608  0.1672  0.0735 -0.0327  0.2526 ...
 $ medn.re: num   0.0945  0.2391 -0.0409 -0.1483  0.2526 ...
name of Evaluation List: a list of "Evaluation" objects
name of Dataobject: object
name of Datafile: contsim_01
----------------------------------
...
Result:
    mean.id             mean.re         
 Min.   :-0.566895   Min.   :-1.987328  
 1st Qu.:-0.128019   1st Qu.:-0.311745  
 Median :-0.001204   Median :-0.001209  
 Mean   : 0.004164   Mean   : 0.015014  
 3rd Qu.: 0.134583   3rd Qu.: 0.354458  
 Max.   : 0.642681   Max.   : 2.130332  
----------------------------------
name of Evaluation: object
estimator: mestimator
Result:
    mstm.id            mstm.re         
 Min.   :-0.69066   Min.   :-0.678037  
 1st Qu.:-0.13360   1st Qu.:-0.151168  
 Median : 0.00941   Median : 0.003313  
 Mean   : 0.00525   Mean   : 0.003866  
 3rd Qu.: 0.14388   3rd Qu.: 0.149347  
 Max.   : 0.68369   Max.   : 0.863343  
----------------------------------
name of Evaluation: object
estimator: median
Result:
    medn.id             medn.re         
 Min.   :-0.884319   Min.   :-0.884319  
 1st Qu.:-0.142206   1st Qu.:-0.162606  
 Median : 0.006154   Median : 0.002193  
 Mean   : 0.007590   Mean   : 0.004666  
 3rd Qu.: 0.161159   3rd Qu.: 0.177439  
 Max.   : 0.825752   Max.   : 0.900305  
\end{Soutput}
\end{Schunk}
