...
\end{Sinput}
\begin{Soutput}
 [1]  9.368665  7.009492  8.681044  7.638800  5.948332  8.484756 10.141577
 [8]  7.125149  4.206934  6.686592  9.795605  8.859790  9.547660  4.370129
[15]  6.862772 11.677068  4.768626  7.738503  8.312697  5.328832  3.570804
[22]  7.637009  4.404166  8.271208 14.552217  6.817530  5.627259 10.627528
[29]  5.830270  9.101205  4.127078 13.712132  7.517051  7.110819  4.160900
[36]  6.827977  9.649462  4.656837  8.588488  3.504020 10.058272  7.280270
[43] 11.477774  8.752581  8.886697 10.917025 12.798755  8.262264  7.922088
[50]  7.869214
\end{Soutput}
\end{Schunk}
...
\end{Sinput}
\begin{Soutput}
 [1] -1.0403320 -0.3282460  0.8154291  1.1568184  0.7075162 -1.7771224
 [7] -1.8527333  0.3176103  1.7405217 -0.1277648
\end{Soutput}
\end{Schunk}
%
...
\end{Sinput}
\begin{Soutput}
Kolmogorov distance of cdfs:	 2.028311e-07 
\end{Soutput}
\begin{Sinput}
> # 2.03e-07
> 
...
\end{Sinput}
\begin{Soutput}
Kolmogorov distance of cdfs:	 6.5379e-05 
\end{Soutput}
\begin{Sinput}
> # ~5e-06
> 
...
\end{Sinput}
\begin{Soutput}
 [1]  1.0000000  0.7060386  1.0000000  0.2907470  0.8230530  0.8482795
 [7]  0.4026078  0.8987039  0.5820899 -0.3140811
\end{Soutput}
\begin{Sinput}
...
\end{Sinput}
\begin{Soutput}
 [1] -0.4412463  0.2456303  0.9868237  0.2450146  0.1987208  0.4091190
 [7] -0.4703257  0.1557724 -0.3101479  0.5733542
\end{Soutput}
\begin{Sinput}
> oldpar = par()
> par(mfrow = c(1,2))
...
Seed:  Kind: Mersenne-Twister
       ...
       first 6 numbers:  0219174720	 0832852060	-0367270457
                         1203614763	-0381113721	-0406760514
number of runs: 1000
...
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mean.id: num   0.1160  0.0734 -0.0394  0.3083 -0.4329 ...
 $ mean.re: num   0.1101  0.0607 -0.0178  1.0008 -0.8484 ...
----------------------------------
An Evaluation Object
estimator: mestimator
Result: 'data.frame':	1000 obs. of  2 variables:
 $ mstm.id: num   0.0918 -0.0166 -0.1179  0.3220 -0.4794 ...
 $ mstm.re: num   0.09181  0.00166 -0.09665  0.43387 -0.51671 ...
----------------------------------
An Evaluation Object
estimator: median
Result: 'data.frame':	1000 obs. of  2 variables:
 $ medn.id: num   0.115 -0.052 -0.187  0.276 -0.559 ...
 $ medn.re: num   0.115 -0.052 -0.187  0.393 -0.644 ...
name of Evaluation List: a list of "Evaluation" objects
name of Dataobject: object
name of Datafile: contsim_01
----------------------------------
...
Result:
    mean.id              mean.re         
 Min.   :-0.5616058   Min.   :-1.957068  
 1st Qu.:-0.1203653   1st Qu.:-0.340242  
 Median :-0.0004505   Median : 0.000640  
 Mean   :-0.0008881   Mean   : 0.001126  
 3rd Qu.: 0.1174231   3rd Qu.: 0.337632  
 Max.   : 0.4990808   Max.   : 1.855655  
----------------------------------
name of Evaluation: object
estimator: mestimator
Result:
    mstm.id            mstm.re         
 Min.   :-0.64380   Min.   :-0.633798  
 1st Qu.:-0.12234   1st Qu.:-0.145106  
 Median :-0.00292   Median :-0.008916  
 Mean   :-0.00426   Mean   :-0.006063  
 3rd Qu.: 0.11964   3rd Qu.: 0.134464  
 Max.   : 0.59266   Max.   : 0.729585  
----------------------------------
name of Evaluation: object
estimator: median
Result:
    medn.id             medn.re         
 Min.   :-0.832080   Min.   :-0.832080  
 1st Qu.:-0.141513   1st Qu.:-0.158251  
 Median : 0.005928   Median :-0.002369  
 Mean   :-0.001718   Mean   :-0.004914  
 3rd Qu.: 0.137187   3rd Qu.: 0.150849  
 Max.   : 0.602801   Max.   : 0.703493  
\end{Soutput}
\end{Schunk}
