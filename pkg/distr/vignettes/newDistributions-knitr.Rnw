...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/branches/distr-2.7/pkg/distr/vignettes/newDistributions-knitr.Rnw $}
{$LastChangedDate: 2018-07-08 13:38:54 +0200 (So, 08 Jul 2018) $}
