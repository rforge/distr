...
\lstinputlistingWithPath[firstline=181,lastline=190]{\distrPATH}{R/AllClasses.R}
\item in \pkg{distr}, see source in \file{R/AllClasses.R},  lines 830--857
\lstinputlistingWithPath[firstline=830,lastline=857]{\distrPATH}{R/AllClasses.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 8--16 and 43--53
\lstinputlistingWithPath[firstline=8,lastline=16]{\distrPATH}{R/BinomialDistribution.R}
\lstinputlistingWithPath[firstline=43,lastline=53]{\distrPATH}{R/BinomialDistribution.R}
     and \file{R/AllGenerics}, lines 142--146
\lstinputlistingWithPath[firstline=142,lastline=146]{\distrPATH}{R/AllGenerics.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 18--33
\lstinputlistingWithPath[firstline=18,lastline=33]{\distrPATH}{R/BinomialDistribution.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  line 41
\lstinputlistingWithPath[firstline=41,lastline=41]{\distrPATH}{R/BinomialDistribution.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 54--69
\lstinputlistingWithPath[firstline=54,lastline=69]{\distrPATH}{R/BinomialDistribution.R}
\item in \pkg{distr}, see sources in
\lstset{language=TeX,basicstyle=\color{black}\tiny}
\begin{itemize}
     \item\file{man/BinomParameter-class.Rd}
\lstinputlistingWithPath{\distrPATH}{man/BinomParameter-class.Rd}
   \item\file{man/Binom-class.Rd}
  \lstinputlistingWithPath{\distrPATH}{man/Binom-class.Rd}
...
\lstinputlistingWithPath[firstline=293,lastline=299]{\distrExPATH}{R/Expectation.R}
      \item\file{Functionals.R}, lines 158--165
\lstinputlistingWithPath[firstline=158,lastline=165]{\distrExPATH}{R/Functionals.R}
      \item\file{skewness.R}, lines 60--67
\lstinputlistingWithPath[firstline=60,lastline=67]{\distrExPATH}{R/Skewness.R}
      \item\file{kurtosis.R}, lines 69--77
\lstinputlistingWithPath[firstline=69,lastline=77]{\distrExPATH}{R/Kurtosis.R}
\end{itemize}
\end{enumerate}
