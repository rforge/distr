...
\lstinputlisting[firstline=181,lastline=190]{../../R/AllClasses.R}
\item in \pkg{distr}, see source in \file{R/AllClasses.R},  lines 830--857
\lstinputlisting[firstline=830,lastline=857]{../../R/AllClasses.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 8--16 and 43--53
\lstinputlisting[firstline=8,lastline=16]{../../R/BinomialDistribution.R}
\lstinputlisting[firstline=43,lastline=53]{../../R/BinomialDistribution.R}
     and \file{R/AllGenerics}, lines 142--146
\lstinputlisting[firstline=142,lastline=146]{../../R/AllGenerics.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 18--33
\lstinputlisting[firstline=18,lastline=33]{../../R/BinomialDistribution.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  line 41
\lstinputlisting[firstline=41,lastline=41]{../../R/BinomialDistribution.R}
\item in \pkg{distr}, see source in \file{R/BinomialDistribution.R},  lines 54--69
\lstinputlisting[firstline=54,lastline=69]{../../R/BinomialDistribution.R}
\item in \pkg{distr}, see sources in
\begin{itemize}
     \item\file{man/BinomParameter-class.Rd}
\lstinputlisting[language=TeX,basicstyle=\color{black}\tiny]{../../man/BinomParameter-class.Rd}
   \item\file{man/Binom-class.Rd} 
  \lstinputlisting[language=TeX,basicstyle=\color{black}\tiny]{../../man/Binom-class.Rd}
