...
\svnidlong
{$HeadURL: svn+ssh://ruckdeschel@svn.r-forge.r-project.org/svnroot/distr/branches/distr-2.4/pkg/SweaveListingUtils/vignettes/ExampleSweaveListingUtils.Rnw $}
{$LastChangedDate: 2011-11-18 13:53:00 +0100 (Fr, 18 Nov 2011) $}
